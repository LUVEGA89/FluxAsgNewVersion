...
namespace Facturacion.Service.Formatos {
    ...
    public class FacturaMassriv : ReportClass {
        
        public FacturaMassriv() {
        }
        
        public override string ResourceName {
            get {
                return "FacturaMassriv.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "Facturacion.Service.Formatos.FacturaMassriv.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedFacturaMassriv : Component, ICachedReport {
        
        public CachedFacturaMassriv() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            FacturaMassriv rpt = new FacturaMassriv();
            rpt.Site = this.Site;
            return rpt;
        }
